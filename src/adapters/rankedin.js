...
// when a player has no country on file — 1,769 of ~3,000 player slots on
// 2026-08-27 — and ISO 3166-2 subdivisions like "gb-eng". Neither is our bug to
// invent a value for, but neither may be passed through either: the client maps any
// two-letter code straight to regional-indicator glyphs, so a bogus one renders as a
// wrong flag, which is worse than no flag. Hence an allowlist, not a shape check —
// the next sentinel may well be two letters. Sibling of iso2() in sporteaser.js.
const ISO_A2 = new Set((
